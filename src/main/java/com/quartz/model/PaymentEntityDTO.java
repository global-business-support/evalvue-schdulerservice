...
public class PaymentEntityDTO {
	...
	private static PaymentEntityDTO paymentEntityFromInvoice;

	private PaymentEntityDTO() {

	}

	public static PaymentEntityDTO getInstance() {
		if (paymentEntityFromInvoice == null)
			paymentEntityFromInvoice = new PaymentEntityDTO();
		return paymentEntityFromInvoice;
	}
